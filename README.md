- [🚴‍♂️ 基础知识](#️-基础知识)
  ...
  - [前端存储](#前端存储)
      ...
      - [2. cookie 如何携带到跨域的接口上？](#2-cookie-如何携带到跨域的接口上)
      - [3. cookie如果很大有什么危害？该怎么优化？](#3-cookie如果很大有什么危害该怎么优化)
- [🤺 前端框架/库](#-前端框架库)
  - [React](#react)
...
- [🎯 web 安全](#-web-安全)
  ...
  - [安全防范](#安全防范)
      - [1. cookie 的安全问题怎么避免？](#1-cookie-的安全问题怎么避免)
- [🧩 数据结构\&算法](#-数据结构算法)
  - [算法](#算法)
...
#### 2. cookie 如何携带到跨域的接口上？

#### 3. cookie如果很大有什么危害？该怎么优化？
...
- **利用索引键**值：在列表组件中，使用带有唯一标识符的数据结构作为 key，可以提高列表渲染性能。
